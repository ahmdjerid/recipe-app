...
export class RecipeService {
  ...
  recipes: Recipe[] = [new Recipe(
    ...
    , this.ingredients),
  new Recipe('Millefeuilles', 'Le millefeuille est un gateau délicieu ', 'https://2.bp.blogspot.com/-lqcyk3RJkSw/WIPGE3ta2gI/AAAAAAAAWLk/8LqWxdgtKTcyq4-cKcalsQyAX-7B2uI1ACLcB/s1600/mille-feuilles-maison.jpg',
    this.ingredients)
  ];
